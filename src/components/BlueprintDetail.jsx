    ...
    <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4 backdrop-blur-sm" onClick={onClose}>
      <div ref={setScrollableRef} className="bg-gradient-to-b from-gray-900 to-gray-950 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto border-2 border-cyan-700/50 relative" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-6 space-y-3">
          ...
          {/* Stats Row and Creator - All on one line */}
          <div className="flex flex-col lg:flex-row gap-3 items-stretch">
            ...
            <div className="grid grid-cols-3 gap-2 lg:flex-1">
              <div className="bg-blue-900/30 p-2 rounded-lg border-2 border-cyan-700/50 text-center">
                <div className="text-base font-bold text-amber-300">{downloadCount}</div>
                <div className="text-xs text-gray-400 flex items-center justify-center mt-0.5">
            ...
            {/* Creator Info */}
            <div className="bg-gradient-to-r from-cyan-900/30 to-blue-900/30 p-2 rounded-lg border-2 border-cyan-700/50 lg:flex-1">
              <div className="flex items-center gap-2 h-full">
                ...
                <div className="min-w-0">
                  ...
                  <button
                    ...
                    className="font-semibold text-amber-300 hover:text-amber-200 hover:underline transition cursor-pointer text-sm"
                  >
