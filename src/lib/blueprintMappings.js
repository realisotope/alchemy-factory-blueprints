...
export const BUILDING_MAPPINGS = {
  ...
  Filter_Vert: { id: "filter_vert", name: "Filter Vert", icon: "/icons/buildings/filtervert.png" },
  ...
  Merger_Vert: { id: "merger_vert", name: "Merger Vert", icon: "/icons/buildings/mergervert.png" },
  ...
  OmniMachine: { id: "omni-machine", name: "Advanced Assembler", icon: "/icons/buildings/advancedassembler.png" },
  ...
  Portal_AlchGuild: { id: "portal_alchguild", name: "Portal Alch Guild", icon: "/icons/buildings/portalalchguild.png" },
  ...
  Splitter_Vert: { id: "splitter_vert", name: "Vertical Splitter", icon: "/icons/buildings/verticalsplitter.png" },
