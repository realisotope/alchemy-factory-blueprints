...
export const MATERIAL_MAPPINGS = {
  ...
  WorldTreeSeed: { id: "world-tree-seeds", name: "World Tree Seeds", icon: "/icons/materials/world-tree-seeds.png" },
...
export const BUILDING_MAPPINGS = {
  ...
  Beam3: { id: "beam3", name: "Beam3", icon: "/icons/buildings/beam3.png" },
  ...
  ConveyerLift_Upwards: { id: "conveyerlift_upwards", name: "Conveyer Lift Upwards", icon: "/icons/buildings/conveyerlift_upwards.png" },
  ...
  Filter_Vert: { id: "filter_vert", name: "Filter Vert", icon: "/icons/buildings/filter_vert.png" },
  FrameSingle: { id: "framesingle", name: "Frame Single", icon: "/icons/buildings/framesingle.png" },
  ...
  IronStand: { id: "ironstand", name: "Iron Stand", icon: "/icons/buildings/ironstand.png" },
  ...
  Merger_Vert: { id: "merger_vert", name: "Merger Vert", icon: "/icons/buildings/merger_vert.png" },
  ...
  NoticeBoard: { id: "noticeboard", name: "Notice Board", icon: "/icons/buildings/noticeboard.png" },
  OmniMachine: { id: "omni-machine", name: "Omni-Machine", icon: "/icons/buildings/omni-machine.png" },
  ...
  Platform_Wood: { id: "platform_wood", name: "Platform Wood", icon: "/icons/buildings/platform_wood.png" },
  Portal_AlchGuild: { id: "portal_alchguild", name: "Portal Alch Guild", icon: "/icons/buildings/portal_alchguild.png" },
  Portal_Bank: { id: "portal_bank", name: "Portal Bank", icon: "/icons/buildings/portal_bank.png" },
  ...
  RelicStandSmall: { id: "relicstandsmall", name: "Relic Stand Small", icon: "/icons/buildings/relicstandsmall.png" },
  ...
  Splitter_Vert: { id: "splitter_vert", name: "Splitter Vert", icon: "/icons/buildings/splitter_vert.png" },
